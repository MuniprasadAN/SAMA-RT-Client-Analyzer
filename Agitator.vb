...
Public Class Agitator
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            g.FillPie(_brush, 1, Me.Height-30,  50,28, UP_startAngle, UP_sweepAngle)
            g.FillPie(_brush, CSng(Me.Width - (Arc_height)), Me.Height-30, 50, 28, Bott_startAngle, Bott_sweepAngle)
           
            g.FillPolygon(_brush, new Point() { New Point(25, Me.Height-30),New Point( Me.Width - 25, CSng(Me.Height -  _LineSize)),New point( Me.Width - 25, Me.Height-30),New Point( 25, Me.Height - _LineSize)})
           
            
            _pen = New Pen(_brush, _LineSize)
            g.DrawLine(_pen, CSng(Me.Width / 2), CSng(Me.Height -15), CSng(Me.Width / 2), 0)

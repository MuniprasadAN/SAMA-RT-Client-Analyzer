...
Public Class Bin
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            'MyBase.OnPaint(e)
            Dim Arc_height As Integer=25
            Dim Rect_Height As Single = Me.Height/2 +10
            ...
            Dim point2 As New Point(_LineSize,Rect_Height)
            Dim point3 As New Point(CSng((Me.Width/2)-40),(Me.Height-_LineSize)) 
            Dim point4 As New Point(CSng((Me.Width/2)+40),(Me.Height-_LineSize))
            Dim point5 As New Point(CSng(Me.Width-3),Rect_Height)
            Dim point6 As New Point(CSng(Me.Width-_LineSize),Arc_height/2)
            ...
            'g.DrawEllipse(_Pen, _LineSize, _LineSize, Me.Width - _LineSize,Arc_height-_LineSize)
            g.FillEllipse(_brush, _LineSize,_LineSize, Me.Width - _LineSize,Arc_height-_LineSize)

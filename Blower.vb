...
Public Class Blower
    ...
    Public Sub New()
        ...
        Me._label.Location =   New Point((((Me.Width-30) / 2) - (Me._label.Width) / 2),( Me.Height-_LineSize) / 2)
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            Dim _brush As New LinearGradientBrush( Me.ClientRectangle,G_Color1, G_Color2,0.0f,true)
            ...
            g.FillEllipse(_brush, _LineSize, _LineSize, CSng(Me.Width - 30), CSng(Me.Height - (5 / 100) * Me.Height))
            ...
            'g.DrawEllipse(_pen,_LineSize, _LineSize,  CSng(Me.Width -30), CSng(Me.Height - _LineSize))
            ...
            ''For jj As Integer = 1 To 40
            ''    g.FillPie(_Brush, x, 28, wd, wd, 180,(jj) * 10)
            ''Next
            ...
            'g.DrawLine(_pen,Me.Width-7,_LineSize,Me.Width-7,40)
            'g.DrawLine(_pen,Me.Width-7,40,Me.Width-33,40)

            _brush =New LinearGradientBrush( Me.ClientRectangle,G_Color1, G_Color2,0.0f,true )

            'g.DrawEllipse(_Pen,CSng(Me.Width -15) , _LineSize,  13,40-_LineSize)
            'g.FillEllipse(_brush, CSng(Me.Width -15),_LineSize,13,40-_LineSize)

            Me._label.Location = New Point((((Me.Width-30) / 2) - (Me._label.Width) / 2),( Me.Height-_LineSize) / 2)
            Me._label.MaximumSize=New Size(Me.Width -30,0)

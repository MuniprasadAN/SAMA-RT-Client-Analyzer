Public Class BrowseOPCHDA_Tags
    Private Sub Rbtnquery_CheckedChanged(sender As Object, e As EventArgs) Handles Rbtnquery.CheckedChanged
        If Rbtnquery.Checked Then
            GrpBxquery.Enabled = True
            GrpBxAutoUpdate.Enabled = False
        End If
    End Sub

    Private Sub Rbtnautoupdate_CheckedChanged(sender As Object, e As EventArgs) Handles Rbtnautoupdate.CheckedChanged
        If Rbtnautoupdate.Checked Then
            GrpBxAutoUpdate.Enabled = True
            GrpBxquery.Enabled = False
        End If
    End Sub
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        '        If Rbtnquery.Checked Then
        '            OPCHDA_ChannelsList.GVChannelsAdd.CurrentRow.Cells(5).Value = "Query"
        '            OPCHDA_ChannelsList.GVChannelsAdd.CurrentRow.Cells(6).Value = FromDate.Value.Date + " " + FromTime.Value.ToString("HH:mm")
        '            OPCHDA_ChannelsList.GVChannelsAdd.CurrentRow.Cells(7).Value = ToDate.Value.Date + " " + ToTime.Value.ToString("HH:mm")
        '            OPCHDA_ChannelsList.GVChannelsAdd.CurrentRow.Cells(8).Value = Nothing
        '            OPCHDA_ChannelsList.GVChannelsAdd.CurrentRow.Cells(9).Value = CBxIntervalQuery.Text + " " + CBxInterval_Query.Text
        '            OPCHDA_ChannelsList.GVChannelsAdd.CurrentRow.Cells(10).Value = Nothing
        '        End If
        '        If Rbtnautoupdate.Checked Then
        '            OPCHDA_ChannelsList.GVChannelsAdd.CurrentRow.Cells(5).Value = "AutoUpdate"
        '            OPCHDA_ChannelsList.GVChannelsAdd.CurrentRow.Cells(6).Value = Nothing
        '            OPCHDA_ChannelsList.GVChannelsAdd.CurrentRow.Cells(7).Value = Nothing
        '            OPCHDA_ChannelsList.GVChannelsAdd.CurrentRow.Cells(8).Value = CBxLast.Text + " " + CBx_Last.Text
        '            OPCHDA_ChannelsList.GVChannelsAdd.CurrentRow.Cells(9).Value = CBxIntervalAutoUpd.Text + " " + CBxInterval_AutoUpd.Text
        '            OPCHDA_ChannelsList.GVChannelsAdd.CurrentRow.Cells(10).Value = DTimeRelative.Value.ToString("HH:mm")
        '        End If

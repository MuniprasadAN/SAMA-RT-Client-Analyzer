...
Public Class Conveyor
    ...
    Private _LineSize As Integer = 9
    ...
    End Enum
    Public Sub New()
        Me.Size = New Size(459, 87)
        
        Me.MinimumSize = New Size(100, 50)
        Me._Gradient_Type = Gradient_Type.diagonal
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            g.FillEllipse(_brush,csng(_LineSize/2), _LineSize, 80,  CSng(Me.Height - (2*_LineSize)))
            g.FillEllipse(_brush, Me.Width - 83, _LineSize, 80, CSng(Me.Height - (2*_LineSize)))

            g.DrawEllipse(_pen, csng(_LineSize/2), _LineSize, 80, CSng(Me.Height - (2*_LineSize)))
            g.DrawEllipse(_pen, Me.Width - 83, _LineSize, 80, CSng(Me.Height - (2*_LineSize)))
            g.DrawLine(_pen, 45, _LineSize, Me.Width - 45, _LineSize) 'H Line
            g.DrawLine(_pen, 45, CSng(Me.Height - _LineSize), Me.Width - 45, CSng(Me.Height -_LineSize)) 'H Line

...
Public Class Cyclone_Seperator
    ...
    End Enum
    Public Sub New()
        Me.Size = New Size(205, 264)
        
        Me.MinimumSize = New Size(140, 200)
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            Dim point1 As New Point(CSng((Me.Width / 2)), 60)
            Dim point2 As New Point(csng(Arc_height/2), 60)
            Dim point3 As New Point(csng(Arc_height/2), 30)
           

            Dim point4 As New Point(Me.Width - 30, 30)
            Dim point5 As New Point(Me.Width - 30, CSng((Me.Height / 2) + 15))
            Dim point6 As New Point(CSng((Me.Width / 2) + 15), Me.Height - 40)
            Dim point7 As New Point(CSng((Me.Width / 2) + 15), Me.Height - csng(Arc_height/2))
            Dim point8 As New Point(CSng((Me.Width / 2) - 15), Me.Height - csng(Arc_height/2))
            Dim point9 As New Point(CSng((Me.Width / 2) - 15), Me.Height - (30+ csng(Arc_height/2)))
            Dim point10 As New Point(30, CSng((Me.Height / 2) + 15))
            Dim point11 As New Point(30, 60)
            'Point1

            Dim Points() As Point = {point1, point2, point3, point4, point5, point6, point7, point8, point9,point10, point11}
            Dim Cap_Points() As Point={New Point(CSng(Me.Width/2 -40),30),New Point(CSng(Me.Width/2 -40),3),New Point(CSng(Me.Width/2 +40),3),New Point(CSng(Me.Width/2 +40),30)}
            g.FillPolygon(_brush, Cap_Points)
            g.FillPolygon(_brush, Points)

            g.DrawPolygon(_pen, Points)
            g.DrawPolygon(_pen, Cap_Points)


            

            'Bottom
            g.DrawEllipse(_Pen, CSng((Me.Width / 2) - 15), Me.Height-Arc_height, Me.Width - (2* CSng((Me.Width / 2) - 15)),15)
            g.FillEllipse(_brush,  CSng((Me.Width / 2) - 15), Me.Height-Arc_height, Me.Width - (2* CSng((Me.Width / 2) - 15)),15)

            'Left Ellipse
           
            g.FillEllipse(_brush, _LineSize, 30, Arc_height,30)
            g.DrawEllipse(_Pen, _LineSize, 30, Arc_height,30)

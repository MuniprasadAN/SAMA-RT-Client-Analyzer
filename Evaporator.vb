...
Public Class Evaporator
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            g.FillRectangle(_Brush, _LineSize,_LineSize, CSng(Me.Width - _LineSize), CSng(Me.Height -_LineSize))
            g.DrawRectangle(_pen, _LineSize,_LineSize, CSng(Me.Width - _LineSize), CSng(Me.Height -_LineSize))

            g.DrawLine(_pen, _LineSize,_LineSize+15, CSng(Me.Width-((Arc_height+10)/2)), _LineSize+15)
            g.DrawLine(_pen, _LineSize,(Me.Height-(_LineSize+15)), CSng(Me.Width-((Arc_height+10)/2)), (Me.Height-(_LineSize+15)))

            Dim Bott_startAngle As Single = -270.0F
            Dim Bott_sweepAngle As Single = -180.0F

            
            g.DrawArc(_Pen,Me.Width-(Arc_height+10), _LineSize+15,Arc_height, Csng( Me.Height -(2* (_LineSize+15))), Bott_startAngle, Bott_sweepAngle)

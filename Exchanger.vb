...
Public Class Exchanger
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            g.FillEllipse(_brush, _LineSize, _LineSize, CSng(Me.Width - (2 * _LineSize)), CSng(Me.Height - (2 * _LineSize)))
            g.DrawEllipse(_pen, _LineSize, _LineSize, CSng(Me.Width - (2 * _LineSize)), CSng(Me.Height - (2 * _LineSize)))


            Dim point1 As New Point(0, CSng(Me.Height / 2))
            Dim point2 As New Point(30, CSng(Me.Height / 2))
            Dim point3 As New Point(CSng((Me.Width / 2 - 20)), CSng((Me.Height / 2 - 30)))
            Dim point4 As New Point(CSng((Me.Width / 2) + 20), CSng((Me.Height / 2) + 30))
            Dim point5 As New Point(CSng(Me.Width - 30), CSng(Me.Height / 2))
            Dim point6 As New Point(CSng(Me.Width), CSng(Me.Height / 2))
            Dim point7 As New Point(CSng(Me.Width - 30), CSng(Me.Height / 2))
            Dim curvePoints As Point() = {point1, point2, point3, point4, point5, point6, point7, point4, point3, point2, point1}


            'g.DrawLine(_pen,Csng(Me.Width/2),0,Csng(Me.Width/2),30)

            ' g.DrawLine(_pen,Csng(Me.Width/2),Me.Height,Csng(Me.Width/2),Me.Height-30)

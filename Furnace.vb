...
Public Class Furnace
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            Dim point3 As New Point(CSng(Me.Width - _LineSize), CSng(ht))
            Dim point4 As New Point(CSng((wd) + wd / 2), CSng(ht - (ht / 2)))

            Dim point5 As New Point(CSng((wd) + wd / 2), csng(Arc_height/2))

            Dim point6 As New Point(CSng((wd) - wd / 2), csng(Arc_height/2))

            Dim point7 As New Point(CSng((wd) - wd / 2),  CSng(ht - (ht / 2)))

            Dim point8 As New Point(1, CSng(ht))


            Dim curvePoints As Point() = {point1, point2, point3, point4, point5, point6, point7, point8, point1}

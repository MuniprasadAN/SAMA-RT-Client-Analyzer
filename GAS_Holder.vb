...
Public Class GAS_Holder
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            'Top Cap
            g.FillPie(_brush, Cap_Size-Cap_Size/2, 1, Cap_Size ,80, 180.0F,180.0F)

            _brush=New LinearGradientBrush( Me.ClientRectangle,G_Color1, G_Color2,0.0f,true )
           
            'Top
            g.FillPie(_brush,_LineSize, _LineSize+10, Me.Width -(2*_LineSize) ,Arc_Height+100, 180.0F,180.0F)
            
            'Bottom
            g.FillEllipse(_brush, _LineSize,CSng(Me.Height-(Arc_height)), Me.Width - _LineSize,Arc_height-_LineSize)

            g.FillRectangle(_brush, _LineSize, (Arc_Height+100)/2, CSng(Me.Width-3), CSng(Me.Height - (Arc_Height+50)))

             _brush=New LinearGradientBrush( Me.ClientRectangle,G_Color1, G_Color2,15.0f,true )
            g.FillPie(_brush,_LineSize, (Arc_Height+100)/2, Me.Width -_LineSize ,5, -180.0F,-180.0F)

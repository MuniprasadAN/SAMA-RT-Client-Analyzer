...
Public Class Mill
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            Dim point1 As New Point(1, CSng(Me.Height / 2 -20))
            Dim point2 As New Point(30, CSng(Me.Height / 2-20))
            Dim point3 As New Point(70, 10)
            Dim point4 As New Point(Me.Width-70, 10)
            Dim point5 As New Point(Me.Width - 30, CSng(Me.Height / 2-20))
            Dim point6 As New Point(CSng(Me.Width -3),CSng(Me.Height / 2-20))
            Dim point7 As New Point(CSng(Me.Width -3),CSng(Me.Height / 2+20))
            Dim point8 As New Point(CSng(Me.Width -30),CSng(Me.Height / 2+20))
            Dim point9 As New Point(CSng(Me.Width -70),CSng(Me.Height-10))
            Dim point10 As New Point(70,CSng(Me.Height-10))
            Dim point11 As New Point(30,CSng(Me.Height / 2+20))
            Dim point12 As New Point(1,CSng(Me.Height/2 + 20))
            Dim point13 As New Point(1,CSng(Me.Height / 2-20))

            Dim curvePoints As Point() = {point1, point2, point3, point4, point5, point6, point7,point8, point9, point10, point11, point12, point13}

            g.FillPolygon(_brush, curvePoints)
            g.DrawPolygon(_pen, curvePoints)
            g.FillRectangle(_brush, 70, 1,15,Me.Height-3)
            g.FillRectangle(_brush,Me.Width-85,1,15,Me.Height-3)
            g.DrawRectangle(_pen, 70, 1,15,Me.Height-3)
            g.DrawRectangle(_pen,Me.Width-85,1,15,Me.Height-3)

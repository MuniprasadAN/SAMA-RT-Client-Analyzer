...
Public Class PressureStorage_Vessel
    ...
    Private Circle_Height As Single=((Me.Height/2)+50)
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
           ...
           Dim g As Graphics = e.Graphics
            ...
            Dim Cap_Size As Single=Me.Width/2
            Dim _pen As New Pen(_brush,_LineSize)
            _brush.Blend = blend
            Dim wd As Single=10.0
            Circle_Height =((Me.Height/2)+50)
            ...
            _brush=New LinearGradientBrush( Me.ClientRectangle,G_Color1, G_Color2,0.0f,true )
             'Top
            g.FillPie(_brush, Cap_Size-Cap_Size/2, 1, Cap_Size ,85, 180.0F,180.0F)

            _brush=New LinearGradientBrush( Me.ClientRectangle,G_Color1, G_Color2,90.0f,true )

            _pen = New Pen(_brush,10)

            g.DrawLine(_pen, wd,Circle_Height/2 +3,wd,Me.Height)'Left Vertical Line
            g.DrawLine(_pen, CSng(Me.Width-wd),Circle_Height/2 +3 ,CSng(Me.Width-wd),Me.Height)'Right Vertival Line
            ...
            g.FillEllipse(_brush, 5, wd+5,  CSng(Me.Width - (5 * 2)), Circle_Height)
            g.DrawEllipse(_pen, 5, wd+5,  CSng(Me.Width - (5 * 2)), Circle_Height)

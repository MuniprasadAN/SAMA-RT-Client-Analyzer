...
Public Class Reciprocating_Compressor
   ...
   Private _label As Label
    ...
    Public Sub New()
        Me.MinimumSize = New Size(100, 70)
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            Dim CP_H As Single = Me.Height * (25 / 100)

            g.TranslateTransform(CSng(Me.Width), CSng(Me.Height))

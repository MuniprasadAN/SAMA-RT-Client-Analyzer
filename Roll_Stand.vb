...
Public Class Roll_Stand
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            Dim in_H As Single = ((Me.Height / 2) / 2)
            Dim in_W As Single = ((Me.Width / 2) / 2)
            g.SmoothingMode = SmoothingMode.AntiAlias

            g.FillEllipse(_brush, 30, 1, CSng(Me.Width / 2 - 1), CSng(Me.Height / 2 - 1))
            g.DrawEllipse(_pen, 30, 1, CSng(Me.Width / 2 - 1), CSng(Me.Height / 2 - 1))
            g.DrawLine(_pen, 0, CSng(Me.Height / 2), Me.Width - 3, CSng(Me.Height / 2)) 'H Line

            g.FillEllipse(_brush, 40, CSng(Me.Height / 2 + 1), CSng(Me.Width / 2 - 1), CSng(Me.Height / 2 - 3))
            g.DrawEllipse(_pen, 40, CSng(Me.Height / 2 + 1), CSng(Me.Width / 2 - 1), CSng(Me.Height / 2 - 3))

            _brush = New LinearGradientBrush(Me.ClientRectangle, G_Color1, G_Color2, 45.0F, True)
            g.FillEllipse(_brush, 20+in_W ,in_H-10,  20, 20)
            g.FillEllipse(_brush,    30+in_W, Me.Height - (in_H+10), 20, 20)

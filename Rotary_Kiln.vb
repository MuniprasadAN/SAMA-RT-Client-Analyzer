   ...
   Private _label As Label
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            Dim _RectWidth As Single = 20.0

            g.SmoothingMode = SmoothingMode.AntiAlias


            g.FillRectangle(_brush, _LineSize, 10, Me.Width - _LineSize, CSng(Me.Height - 20))
            g.DrawRectangle(_pen, _LineSize, 10, Me.Width - _LineSize, CSng(Me.Height - 20))

            g.FillRectangle(_brush, _RectWidth + 10, _LineSize, _RectWidth, CSng(Me.Height - _LineSize))
            g.FillRectangle(_brush, CSng(Me.Width - (2 * _RectWidth)), _LineSize, _RectWidth, CSng(Me.Height - _LineSize))
            g.DrawRectangle(_pen, _RectWidth + 10, _LineSize, _RectWidth, CSng(Me.Height - _LineSize))
            g.DrawRectangle(_pen, CSng(Me.Width - (2 * _RectWidth)), _LineSize, _RectWidth, CSng(Me.Height - _LineSize))

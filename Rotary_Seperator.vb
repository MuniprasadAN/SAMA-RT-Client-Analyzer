   ...
   Public _ThresholdValue As New List(Of String)
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            Dim R_x As Integer=10
            Dim Arc_Height As Single=50
            Dim Rect_Y As Integer=(Me.Height/2)/2
                   
            g.FillEllipse(_brush, _LineSize,CSng(Me.Height-(Arc_height)), Me.Width - _LineSize,Arc_height-_LineSize)
            
            g.FillRectangle(_brush, _LineSize, Rect_Y, CSng(Me.Width-3), CSng(Me.Height -( Rect_Y+Arc_Height/2)))
            
            g.FillPolygon(_brush,New Point(){New Point(_lineSize,Rect_Y),New Point(Me.Width/2,_LineSize),New Point(me.Width-_LineSize,Rect_Y)})
        
           
             For jj As Integer = 1 To 10
                g.DrawPie(_pen,  R_x, Rect_Y, Me.Width -(2*R_x) ,CSng(Me.Height -( Rect_Y+Arc_Height/2)), 180, (jj) * 40)
            Next

...
Public Class StateIndicator
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            Dim _brush As New LinearGradientBrush(Me.ClientRectangle,Color.White, Color.Black,0.0f,False )
           _Gradient_Type=Gradient_Type.Vertical
            Select Case _Gradient_Type
                Case Gradient_Type.Vertical
                    ...
                    _brush = New LinearGradientBrush(Me.ClientRectangle,Color.Black, Color.Snow,0.0f,False )
            ...
            g.FillEllipse( _brush, Out_Area, Out_Area, CSng(Me.Width -(Out_Area*3)), CSng(Me.Height-(Out_Area*2) ))
            g.DrawEllipse( _pen, Out_Area, Out_Area, CSng(Me.Width -(Out_Area*3)), CSng(Me.Height-(Out_Area*2) ))
            _brush=Nothing
             _brush = New LinearGradientBrush(Me.ClientRectangle,G_Color1, G_Color1,15.0f,False )
            g.FillEllipse( _brush, 7, 7, CSng(Me.Width -(7*2)), CSng(Me.Height-(7*2) ))
            g.DrawEllipse( _pen, 7, 7, CSng(Me.Width -(7*2)), CSng(Me.Height-(7*2) ))

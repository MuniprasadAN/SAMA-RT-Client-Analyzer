Public Class SymbolPropertiesForm
...
Private Sub ValvePropertiesForm_Load( ByVal sender As System.Object,  ByVal e As System.EventArgs) Handles MyBase.Load
    Try
         Symbols_Ctl=MainPage.Symbol_Ctrl
...
Private Sub btnOK_Click( ByVal sender As System.Object,  ByVal e As System.EventArgs) Handles btnOK.Click
  MainPage.modify = True
        ...
        Call Properties(Symbols_Ctl)
       
End Sub
    Private Sub Properties(ByVal Symbols_Ctrl As Object )
        'BackColor Setting
       Try
            Symbols_Ctrl.Gradient_Color1=lblBackClr.BackColor
        Symbols_Ctrl.D_Color1=lblBackClr.BackColor
        Symbols_Ctrl.Description=txtDesc.Text
        Symbols_Ctrl.Forecolor=forecolorLbl.BackColor
        Dim ss() As string= {"=", ">", "<", ">=", "<=", ">=<="}
      
        
        Symbols_Ctrl._ThresholdValue.Clear()
        Symbols_Ctrl._THColor.Clear()
        Symbols_Ctrl._THCondition.Clear()
        ...
        For i As Integer = 0 To GVTHValue.Rows.Count - 1
           If  Not String.IsNullOrEmpty( GVTHValue.Rows(i).Cells(0).Value) AndAlso ss.Contains(GVTHValue.Rows(i).Cells(0).Value) Then
                 If  Not String.IsNullOrEmpty( GVTHValue.Rows(i).Cells(1).Value) Then
                    Symbols_Ctrl._THCondition.Add(GVTHValue.Rows(i).Cells(0).Value)
                    Symbols_Ctrl._ThresholdValue.Add(GVTHValue.Rows(i).Cells(1).Value )
                    Symbols_Ctrl._THColor.Add(GVTHValue.Rows(i).Cells(2).Style.BackColor.ToArgb)
                Else
        ...
        Symbols_Ctrl.AccessibleDescription = cBoxActionChannel.Text
        Me.close
       Catch ex As Exception
            MsgBox(ex.Message & " :SymbolPropFormProperties()")
       End Try
...
Private Sub forecolorLbl_dblClick( ByVal sender As System.Object,  ByVal e As System.EventArgs) Handles forecolorLbl.DoubleClick
        ColDialog.ShowDialog()
        ColDialog.FullOpen = False
        sender.Backcolor = ColDialog.Color
End Sub

...
Public Class Transformer
   ...
   Private _label As Label
    ...
    End Enum
    Public Sub New()
        Me.MinimumSize = New Size(120, 100)
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            Dim Bott_startAngle As Single = 90.0F
            Dim Bott_sweepAngle As Single = -180.0F
            Dim Arc_Size As Integer = ((Me.Width / 2) / 2)

            Dim y As Integer = 20

            g.SmoothingMode = SmoothingMode.AntiAlias
            g.FillRectangle(_brush, 0, y, Me.Width , Me.Height)

            g.DrawArc(_pen, _LineSize, y + 10, Arc_Size, CSng(Me.Height / 2 - y), Bott_startAngle, Bott_sweepAngle)
            g.DrawArc(_pen, _LineSize, CSng(Me.Height / 2 + 10), Arc_Size, CSng(Me.Height / 2 - y), Bott_startAngle, Bott_sweepAngle)

            g.DrawLine(_pen, CSng(Me.Width / 2 - 15), y, CSng(Me.Width / 2 - 15), Me.Height - _LineSize)
            g.DrawLine(_pen, CSng(Me.Width / 2 + 15), y, CSng(Me.Width / 2 + 15), Me.Height - _LineSize)

            g.DrawArc(_pen, CSng(Me.Width - (Arc_Size + _LineSize)), y + 10, Arc_Size, CSng(Me.Height / 2 - y), UP_startAngle, UP_sweepAngle)
            g.DrawArc(_pen, CSng(Me.Width - (Arc_Size + _LineSize)), CSng(Me.Height / 2 + 10), Arc_Size, CSng(Me.Height / 2 - y), UP_startAngle, UP_sweepAngle)


            g.FillRectangle(_brush, _LineSize + 10, _LineSize, Arc_Size, y)
            g.FillRectangle(_brush, Me.Width - (_LineSize + 10 + Arc_Size), _LineSize, Arc_Size, y)

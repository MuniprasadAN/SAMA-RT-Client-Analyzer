...
Public Class Turbine
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            Dim Y As Integer=((Me.Height/2)/2)

            Dim point1 As New Point(Me.Width-_LineSize, _LineSize)
            Dim point2 As New Point(Me.Width - _LineSize, Me.Height-_LineSize)
            Dim point3 As New Point( _LineSize, Me.Height - Y)
            Dim point4 As New Point(_LineSize, Y)

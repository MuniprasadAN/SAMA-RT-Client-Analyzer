   ...
   Private _label As Label
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            Dim Line_Height As Single = Me.Height/2
            ' Create points that define polygon. 
            Dim point1 As New Point(_LineSize, Me.Height - _LineSize)
            Dim point2 As New Point(CSng((Me.Width / 2)), Line_Height)
            Dim point3 As New Point(CSng(Me.Width / 2), 0)
            'point2
            Dim point4 As New Point(Me.Width-_LineSize, Me.Height - _LineSize)

            'Dim curvePoints As Point() = {point1, point2,Point3,  point4, point5, point6,point7,point8 }
            Dim curvePoints As Point() = {point1, point2, point3, point2, point4, point2}

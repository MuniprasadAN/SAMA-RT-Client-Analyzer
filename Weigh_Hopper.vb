...
Public Class Weigh_Hopper
   ...
   Public _ThresholdValue As New List(Of String)
    ...
    Public Sub New()
        ...
        Me.MinimumSize = New Size(50, 150)
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Try
            ...
            Dim point1 As New Point(_LineSize, Arc_Height / 2-17)
            Dim point2 As New Point(Me.Width - _LineSize, Arc_Height / 2-17)
            Dim point3 As New Point(Me.Width - _LineSize, CSng((Me.Height / 2) + 15))
            Dim point4 As New Point(CSng((Me.Width / 2) + 15), Me.Height - 40)
            Dim point5 As New Point(CSng((Me.Width / 2) + 15), Me.Height - 15)
            Dim point6 As New Point(CSng((Me.Width / 2) - 15), Me.Height - 15)
            Dim point7 As New Point(CSng((Me.Width / 2) - 15), Me.Height - 40)
            Dim point8 As New Point(_LineSize, CSng((Me.Height / 2) + 15))
            'Point1

            Dim Points() As Point = {point1, point2, point3, point4, point5, point6, point7, point8, point1}

             Dim wd As Single=10.0
            _Pen=New Pen(_brush,wd)
            g.DrawLine(_pen,wd,cint(Me.Height / 2),wd,Me.Height)'Left Ver Line
            g.DrawLine(_pen,Me.Width-wd,cint(Me.Height / 2),Me.Width-wd,Me.Height)'Right Ver Line

            g.DrawLine(_pen, 0, Me.Height , 20,Me.Height) 'Bottom Left Horizontal Line
            g.DrawLine(_pen, Me.Width, Me.Height , Me.Width-20,Me.Height ) 'Bottom Right Horizontal Line
            ...
            g.FillEllipse(_brush, CSng((Me.Width / 2) - 15), Me.Height - 25, Me.Width - (2 * CSng((Me.Width / 2) - 15)), 15)
           ...
           'Top
            _brush = New LinearGradientBrush(Me.ClientRectangle, G_Color1, G_Color2, 45.0F, True)
            _Pen=New Pen(_brush,_LineSize)
            g.DrawEllipse(_pen, CSng((Me.Width / 2) - 15), Me.Height - 25, Me.Width - (2 * CSng((Me.Width / 2) - 15)), 15)

            g.FillEllipse(_brush, _LineSize, _LineSize, Me.Width - (2 * _LineSize), Arc_Height/2)
